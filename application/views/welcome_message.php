...
<html>
  ...
  <body id="body">
		  ...
		  <header id="header">
						...
						<div class="row">
    						...
    						<img src="<?php echo base_url(); ?>assets/images/logo.png" width="100" height="100" class="" alt="">
								...
								<div id="redes" class="col-lg-4 col-lg-offset-4" style="font-size: 5.5rem;">
	    ...
	    <a id="color" href="" title="Enlace genérico">Top 10</a>
			...
			<a id="color" href="" title="Enlace genérico">Letras</a>
			<a id="color" href="" title="Enlace genérico">Acerca de</a>
		</nav>
